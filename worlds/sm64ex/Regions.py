...
sm64_level_to_paintings: typing.Dict[Entrances, str] = {
    Entrances.BOB_OMB_BATTLEFIELD: "Bob-omb Battlefield",
    Entrances.WHOMPS_FORTRESS: "Whomp's Fortress",
    Entrances.JOLLY_ROGER_BAY: "Jolly Roger Bay",
    Entrances.COOL_COOL_MOUNTAIN: "Cool, Cool Mountain",
    Entrances.BIG_BOOS_HAUNT: "Big Boo's Haunt",
    Entrances.HAZY_MAZE_CAVE: "Hazy Maze Cave",
    Entrances.LETHAL_LAVA_LAND: "Lethal Lava Land",
    Entrances.SHIFTING_SAND_LAND: "Shifting Sand Land",
    Entrances.DIRE_DIRE_DOCKS: "Dire, Dire Docks",
    Entrances.SNOWMANS_LAND: "Snowman's Land",
    Entrances.WET_DRY_WORLD: "Wet-Dry World",
    Entrances.TALL_TALL_MOUNTAIN: "Tall, Tall Mountain",
    Entrances.TINY_HUGE_ISLAND_TINY: "Tiny-Huge Island (Tiny)",
    Entrances.TINY_HUGE_ISLAND_HUGE: "Tiny-Huge Island (Huge)",
    Entrances.TICK_TOCK_CLOCK: "Tick Tock Clock",
    Entrances.RAINBOW_RIDE: "Rainbow Ride"
}
...
sm64_level_to_secrets: typing.Dict[Entrances, str] = {
    Entrances.THE_PRINCESS_SECRET_SLIDE: "The Princess's Secret Slide",
    Entrances.THE_SECRET_AQUARIUM: "The Secret Aquarium",
    Entrances.BOWSER_IN_THE_DARK_WORLD: "Bowser in the Dark World",
    Entrances.TOWER_OF_THE_WING_CAP: "Tower of the Wing Cap",
    Entrances.CAVERN_OF_THE_METAL_CAP: "Cavern of the Metal Cap",
    Entrances.VANISH_CAP_UNDER_THE_MOAT: "Vanish Cap under the Moat",
    Entrances.BOWSER_IN_THE_FIRE_SEA: "Bowser in the Fire Sea",
    Entrances.WING_MARIO_OVER_THE_RAINBOW: "Wing Mario over the Rainbow"
}
